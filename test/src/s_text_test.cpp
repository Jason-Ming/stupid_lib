...
TEST(htoi, invalid_str_0x_empty)
{
    const _S8 *str = "0x";
    ENUM_RETURN retval = RETURN_FAILURE;
    //_S64 result = 0x00;
...
TEST(htoi, invalid_str_suffix_blank)
{
    const _S8 *str = "34f ";
    ENUM_RETURN retval = RETURN_FAILURE;
    //_S64 result = 0x00;
...
TEST(htoi, invalid_str_prefix_blank)
{
    const _S8 *str = "  034f";
    ENUM_RETURN retval = RETURN_FAILURE;
